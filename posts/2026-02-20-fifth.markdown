...
## nvm 注入 .zshrc 的脚本会引发副作用，使得无效的补全文件被插入到.zshrc中，这会让zsh的初始化变慢。

export zcompdump="${XDG_CACHE_HOME:-$HOME/.cache}/zsh/zcompdump"
typeset -g _comp_dumpfile="$zcompdump"
zstyle ':zcomet:compinit' dump-file "$zcompdump"

## 作为补救，在zsh上使用zsh-nvm-x，这就是为什么在.zshrc上有着zcomet load seebeen/zsh-nvm-x的一行。

PATH="/home/iris/perl5/bin${PATH:+:${PATH}}";
export PATH;
PERL5LIB="/home/iris/perl5/lib/perl5${PERL5LIB:+:${PERL5LIB}}";
export PERL5LIB;
PERL_LOCAL_LIB_ROOT="/home/iris/perl5${PERL_LOCAL_LIB_ROOT:+:${PERL_LOCAL_LIB_ROOT}}";
export PERL_LOCAL_LIB_ROOT;
PERL_MB_OPT="--install_base \"/home/iris/perl5\"";
export PERL_MB_OPT;
PERL_MM_OPT="INSTALL_BASE=/home/iris/perl5";
export PERL_MM_OPT;
```
...
zcomet load seebeen/zsh-nvm-x

# zcomet load agkozak/polyglot
